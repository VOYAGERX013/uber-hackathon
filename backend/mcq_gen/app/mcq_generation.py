...
from mcq_gen.app.modules.duplicate_removal import remove_distractors_duplicate_with_correct_answer, remove_duplicates
from mcq_gen.app.modules.text_cleaning import clean_text
from mcq_gen.app.ml_models.answer_generation.answer_generator import AnswerGenerator
from mcq_gen.app.ml_models.distractor_generation.distractor_generator import DistractorGenerator
from mcq_gen.app.ml_models.question_generation.question_generator import QuestionGenerator
from mcq_gen.app.ml_models.sense2vec_distractor_generation.sense2vec_generation import Sense2VecDistractorGeneration
from mcq_gen.app.models.question import Question
...
class MCQGenerator():
    ...
    def generate_mcq_questions(self, context: str, desired_count: int) -> List[Question]:
        ...
        for question in questions:
            response["questions"].append(question.questionText)
            response["answers"].append(question.answerText)
            response["distractors"].append(question.distractors)
